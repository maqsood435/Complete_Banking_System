...
class Withdraw_Test implements ActionListener
{
	JFrame f5;
	...
	Withdraw_Test()
	{
		f5=new JFrame("Withdraw Window");
		l1.setBounds(0,0,800,700);
		f5.add(l1);
					
		test=new JLabel("Withdraw Window");
		...
		deposit=new JLabel("Withdraw Amount");
		...
		deposit.setBounds(280,310,150,20);
			...
			if(e.getSource()==generatedet)
			{
				...
				try
				{
					...
					if(rs.next())
					{
						...
						JOptionPane.showMessageDialog(generatedet, "Account no is correct");
...
public static void main(String [] args)
	{
		Withdraw_Test dp=new Withdraw_Test();
